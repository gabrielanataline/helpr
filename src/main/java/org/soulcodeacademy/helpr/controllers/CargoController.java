...
public class CargoController {
    ...
    @PreAuthorize("hasAnyRole('ROLE_ADMIN', 'ROLE_FUNCIONARIO')") // adm e funcionário podem acessar
    @GetMapping("/cargos")
    ...
    @PreAuthorize("hasRole('ROLE_ADMIN')") // apenas admin podem acessar esse endpoint

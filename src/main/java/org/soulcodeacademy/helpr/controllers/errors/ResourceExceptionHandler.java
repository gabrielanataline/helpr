...
@ControllerAdvice    //capacidde de gerenciar os erros que acontecem
public class ResourceExceptionHandler {
    ...
    public ResponseEntity<CustomErrorResponse> recursoNaoEncontradoError(RecursoNaoEncontradoError erro, HttpServletRequest request){
        ...
        return ResponseEntity.status(HttpStatus.NOT_FOUND).body(response);  //Retorna o objeto com os dados e código 404
    }
